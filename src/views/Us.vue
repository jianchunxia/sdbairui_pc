            ...
            <div class="top">
                ...
                <div class="right">
                    ...
                    <form>
                        ...
                        <input class="email" type="email" v-model="email" placeholder="邮箱:">
    ...
    data(){
        return{
            ...
            lianxi:[
                ...
                {img:require('../assets/qiye.png'),text:'山东柏瑞软件科技有限公司'},
                {img:require('../assets/tel.png'),text:'0538-2110108'},
                {img:require('../assets/email.png'),text:'wf18661349342@163.com'},
                {img:require('../assets/dizhi.png'),text:'济南市长清区崮云湖街道芙蓉路中国创新谷西城软件园A3楼503室'},
            ],
